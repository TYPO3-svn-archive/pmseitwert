...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pmseitwert/res/libchart/classes/model/XYSeriesDataSet.php'])    {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/pmseitwert/res/libchart/classes/model/XYSeriesDataSet.php']);
}
?>